...
CHAMPS = {
    ...
    "jengacide": {"display":"Jengacide","type":"nature","base":{"hp":160,"atk":21,"def":13,"spd":7},"moves":[
        {"name":"Blunt Force Trauma","kind":"damage","power":50,"acc":0.85,"def_down_chance":0.18,"def_down_turns":2,"text":["slams forward!","clubs the enemy!","delivers a hit!"]},
        ...
        {"name":"Jenga Joint Collapse","kind":"damage","power":65,"acc":0.75,"high_cooldown":3,"debuff_bonus":True,"text":["lines up the tower!","pulls the block!","ultimate betrayal!"]}]},
}
