...
CHAMPS = {
    "basaurimon": {"display":"Basaurimon","type":"nature","base":{"hp":162,"atk":25,"def":11,"spd":9},"moves":[
    ...
    "jengacide": {"display":"Jengacide","type":"nature","base":{"hp":158,"atk":20,"def":13,"spd":7},"moves":[
        {"name":"Blunt Force Trauma","kind":"damage","power":48,"acc":0.85,"def_down_chance":0.18,"def_down_turns":2,"text":["slams forward!","clubs the enemy!","delivers a hit!"]},
        {"name":"Ketamine Quake","kind":"damage","power":43,"acc":0.82,"stun_chance":0.35,"stun_turns":1,"text":["stomps the ground!","unleashes a tremor!","wobbles reality!"]},
        ...
        {"name":"Jenga Joint Collapse","kind":"damage","power":55,"acc":0.75,"high_cooldown":3,"debuff_bonus":True,"text":["lines up the tower!","pulls the block!","ultimate betrayal!"]}]},
}
